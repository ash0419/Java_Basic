...
public class CollectionTest {
	public static void main(String[] args) {
		...
		System.out.println("용량 : " + v.capacity()); // Vector에만 존재
		...
		// fromindex부터 toindex 사이에 저장된 객체 반환
		print(list, list1);
...
//		list.sort(Comparator.reverseOrder()); // 내림차순
		...
		// contains() : 지정된 객체가 ArrayList에 포함되어 있는지
