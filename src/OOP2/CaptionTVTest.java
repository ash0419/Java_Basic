...
/*
 자바의 상속 특징
 	-단일 상속만 허용
 	-다중 속성 사용 시 여러 복합적인 기능을 가진 클래스의 구현이 가능하지만
 	-서로 다른 클래스로 부터 상속 받은 멤버간의 이름이 같은 경우 구별 불가
 	-대신 클래스 간의 관계가 보다 명확,코드를 더욱 신뢰 가능
 	-비중이 높은 클래스 하나만 상속 관계로 나머지 포함 관계
 */
...
/*
 Object class
 	...
 	-상속 계층의 최상의에 위치
 	-모든 클래스 Objec 클래스에 정의된 11개의 메서드를 상속
 */
